...
$(
  (function() {
    ...
    describe('RSS Feeds', function() {
       ...
       */
      it('have a defined URL and that URL is not empty', function() {
       ...
       */
      it('have a defined name and that name is not empty', function() {
        for (let feed of allFeeds) {
    ...
    describe('The menu', function() {
       ...
       */
      it('show the side menu when the menu icon is clicked and hide it when the menu icon is clicked again', function() {
        menuButton.click();
    ...
    describe('New Feed Selection', function() {
      ...
      it('ensure the content is changed when the feed reloads', function(done) {
